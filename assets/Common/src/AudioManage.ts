class audioManage {
    ...
    playEffect(res:cc.AudioClip | string, loop:boolean=false,volume?:number ){
    ...
    playMusic(res:cc.AudioClip | string, loop:boolean=false,volume?:number ){
        ...
        if ( res instanceof cc.AudioClip) {
            ...
            cc.resources.load(res,cc.AudioClip,null,(error,clip:cc.AudioClip)=>{
