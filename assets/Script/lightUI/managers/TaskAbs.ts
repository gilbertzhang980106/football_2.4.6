...
/**
	 ...
	 */
 export default class TaskAbs extends cc.EventTarget{

    /**@private handler对象池*/
    protected static _pool: TaskAbs[] = [];
    /**@private */
     ...
     */
    setTo(caller: any, method: Function|null, args: any[]|null, once=false): TaskAbs {
     ...
     */
    static create(caller: any, method: Function|null, args: any[]|null = null, once: boolean = true): TaskAbs {
        if (TaskAbs._pool.length) 
            return (TaskAbs._pool.pop() as TaskAbs).setTo(caller, method, args, once);
